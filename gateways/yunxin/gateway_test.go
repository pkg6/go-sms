...
func TestGateWay(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := GateWay(tt.args.appKey, tt.args.appSecret); !reflect.DeepEqual(got, tt.want) {
...
func TestYunXin_AsName(t *testing.T) {
	type fields struct {
		AppKey    string
		AppSecret string
		Lock      gosms.Lock
...
func TestYunXin_Send(t *testing.T) {
	type fields struct {
		AppKey    string
		AppSecret string
		Lock      gosms.Lock
